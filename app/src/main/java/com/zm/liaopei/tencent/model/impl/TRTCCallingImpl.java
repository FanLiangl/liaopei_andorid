package com.zm.liaopei.tencent.model.impl;
...
import com.zm.liaopei.tencent.model.impl.base.CallModel;
import com.zm.liaopei.tencent.model.impl.base.MessageCustom;
import com.zm.liaopei.tencent.model.impl.base.OfflineMessageBean;
import com.zm.liaopei.tencent.model.impl.base.OfflineMessageContainerBean;
import com.zm.liaopei.tencent.model.impl.base.TRTCInternalListenerManager;
import com.zm.liaopei.tencent.model.impl.base.TRTCLogger;
        ...
        switch (realCallModel.action) {
            case CallModel.VIDEO_CALL_ACTION_DIALING:
                ...
                if (isGroup) {
                    ...
                    callID = V2TIMManager.getSignalingManager().invite(receiver, dialingDataStr, false,v2TIMOfflinePushInfo,TIME_OUT_COUNT, new V2TIMCallback() {
                        @Override
                        public void onError(int code, String desc) {
            ...
            case CallModel.VIDEO_CALL_ACTION_HANGUP:
                ...
                if (isGroup) {
                    ...
                    V2TIMOfflinePushInfo v2TIMOfflinePushInfo=new V2TIMOfflinePushInfo();
                    V2TIMManager.getSignalingManager().invite(receiver, hangupMapStr, false,v2TIMOfflinePushInfo, 0,new V2TIMCallback() {
                        @Override
                        public void onError(int code, String desc) {
